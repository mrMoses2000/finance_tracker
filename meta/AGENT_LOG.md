...
|------|-------|--------|--------|
| 2026-01-29 | Codex | Env Auto-Fill Script | Added scripts/ensure_env.sh with interactive menu, env sanitization, run.sh preflight checks, and DB mismatch warnings. |
